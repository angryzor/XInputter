...
public:
	...
	static unsigned int GetUIntValue(string KeyName, string SectionName, string FileName);
	static string GetValueDef(string KeyName, string SectionName, string FileName, string def);
	static int GetIntValueDef(string KeyName, string SectionName, string FileName, int def);
	static unsigned int GetUIntValueDef(string KeyName, string SectionName, string FileName, unsigned int def);
