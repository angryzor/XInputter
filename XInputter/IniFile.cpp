...
string CIniFile::GetValueDef(string KeyName, string SectionName, string FileName, string def){
	string res = GetValue(KeyName,SectionName,FileName);
	if(res == "")
		return def;
	else
		return res;
...
int CIniFile::GetIntValueDef(string KeyName, string SectionName, string FileName, int def){
	istringstream iss(GetValue(KeyName, SectionName, FileName));
	int a;
	if(iss >> a)
		return a;
	else
...
unsigned int CIniFile::GetUIntValueDef(string KeyName, string SectionName, string FileName, unsigned int def){
	istringstream iss(GetValue(KeyName, SectionName, FileName));
	unsigned int a;
	if(iss >> a)
		return a;
...
int CIniFile::GetIntValue(string KeyName, string SectionName, string FileName){
	return GetIntValueDef(KeyName,SectionName,FileName,0);
}

unsigned int CIniFile::GetUIntValue(string KeyName, string SectionName, string FileName){
	return GetUIntValueDef(KeyName,SectionName,FileName,0);
}
